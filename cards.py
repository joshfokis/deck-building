...
diana = Card("Princess Diana of Themyscira", "Hero", 0, 0, 2, 7, False, False,
             True)
...
fortress = Card("Fortress of Solitude", "Location", 0, 0, 1, 5, False, False,
                True)
...
def create_maindeck():
    ...
    for i in range(6):
        suicide = Card("Suicide Squad", "Villain", 2, 0, None, 4, False, False,
                       True)

    for i in range(4):
        kidflash = Card("Kid Flash", "Hero", 0, 1, 1, 2)
        speed = Card("Super Speed", "SuperPower", 0, 1, 1, 3, True)
        nthmetal = Card("Nth Metal", "Equipment", 1, 0, 1, 3, False, False,
                        True)
    ...
    for i in range(3):
        ...
        bulletproof = Card("Bulletproof", "SuperPower", 2, 0, 1, 4, True)
        cowl = Card("The Cape and Cowl", "Equipment", 2, 0, 1, 4, True)
        powerring = Card("Power Ring", "Equipment", 2, 0, 1, 3, False, False,
                         True)
        signal = Card("The Bat Signal", "Equipment", 1, 0, 1, 5, False, False,
                      True)
        robin = Card("Robin", "Hero", 1, 0, 1, 3)
        belt = Card("Utility Belt", "Equipment", 2, 0, None, 5, False, False,
                    True)
        arrow = Card("Green Arrow", "Hero", 2, 0, None, 5, False, False, True)
        heatvision = Card("Heat Vision", "SuperPower", 3, 0, 2, 6, False, False,
                          True)
        bow = Card("Green Arrow's Bow", "Equipment", 2, 0, 1, 4, False, False,
                   True)
        trident = Card("Aquaman's Trident", "Equipment", 2, 0, 1, 3, False,
                       False, True)
        scarecrow = Card("Scarecrow", "Villain", 2, 0, 1, 5, False, True)
    ...
    for i in range(2):
        ...
        harley = Card("Harley Quinn", "Villain", 1, 0, 1, 2, False, True)
        swamp = Card("Swamp Thing", "Hero", 2, 0, 1, 4, False, False, True)
        hightech = Card("High-Tech Hero", "Hero", 1, 0, 1, 3, False, False,
                        True)
        mera = Card("Mera", "Hero", 2, 0, 1, 3, False, False, True)
        xray = Card("X-Ray Vision", "SuperPower", 0, 0, 1, 3, False, False,
                    True)
        clayface = Card("Clayface", "Villain", 0, 0, 1, 4, False, False, True)
        cheetah = Card("Cheetah", "Villain", 0, 0, 1, 2, False, False, True)
        supergirl = Card("Supergirl", "Hero", 0, 0, 1, 4, False, False, True)
        grundy = Card("Solomon Grundy", "Villain", 3, 0, 2, 6, False, False,
                      True)
        twoface = Card("Two-Face", "Villain", 1, 0, 1, 2, False, False, True)
        penguin = Card("Penguin", "Villain", 0, 0, 1, 3, False, False, True)
        batmobile = Card("Batmobile", "Villain", 1, 0, 1, 2, False, False, True)
    ...
    for i in range(1):
        ...
        beetle = Card("Blue Beetle", "Hero", 3, 0, 2, 6, True)
        starro = Card("Starro", "Villain", 0, 0, 2, 7, False, True)
        manofsteel = Card("Man of Steel", "Hero", 3, 0, 3, 8, False, False,
                          True)
        lobo = Card("Lobo", "Villain", 3, 0, 2, 7, False, False, True)
        atlantis = Card("King of Atlantis", "Hero", 1, 0, 1, 5, False, False,
                        True)
        emerald = Card("Emerald Knight", "Hero", 0, 0, 1, 5, False, False, True)
        jonzz = Card("J'onn J'onzz", "Hero", 0, 0, 2, 6, False, False, True)
        bizarro = Card("Bizarro", "Villain", 3, 0, None, 7, False, False, True)
        diana = Card("Princess Diana of Themyscira", "Hero", 0, 0, 2, 7, False,
                     False, True)
        darkknight = Card("Dark Knight", "Hero", 2, 0, 1, 5, False, False, True)
        batcave = Card("The Batcave", "Location", 0, 0, 1, 5, False, False,
                       True)
        titans = Card("Titans Tower", "Location", 0, 0, 1, 5, False, False,
                      True)
        watchtower = Card("The Watchtower", "Location", 0, 0, 1, 5, False,
                          False, True)
        arkham = Card("Arkham Asylum", "Location", 0, 0, 1, 5, False, False,
                      True)
        fortress = Card("Fortress of Solitude", "Location", 0, 0, 1, 5, False,
                        False, True)
