...
# Initialize three static stacks of kicks, weaknesses, and supervillains,
# respectively.
kicks = Stack("Kicks")
...
# For each static stack, display cardtype and number of cards in the stack.
# (These stacks are face up.)
# For main deck, display only number of cards in the stack.
# (Main deck is face down.)
...
this_turn = Turn(new_game.play_order.sequence[0], new_game.maindeck, [],
                 kicks.stack)
